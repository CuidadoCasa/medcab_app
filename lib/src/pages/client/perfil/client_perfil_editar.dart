...
class ClientEditarPerfilPage extends StatefulWidget {
  final String nombreUsuario;
  final String userId;
  
  const ClientEditarPerfilPage({
    super.key,
  ...
  @override
  State<ClientEditarPerfilPage> createState() => _ClientEditarPerfilPageState();
}

class _ClientEditarPerfilPageState extends State<ClientEditarPerfilPage> {
