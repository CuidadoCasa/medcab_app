...
class ClientFotoPerfilPage extends StatefulWidget {
  final String urlFoto;
  final String userId;
  
  const ClientFotoPerfilPage({
    super.key,
  ...
  @override
  State<ClientFotoPerfilPage> createState() => _ClientFotoPerfilPageState();
}

class _ClientFotoPerfilPageState extends State<ClientFotoPerfilPage> {
  ...
  void _crearRegistro() async {
    ...
    try {
      ...
      await _clientProvider!.update(data, widget.userId);
