...
import 'package:app_medcab/src/pages/driver/travel_calification/driver_travel_calification_controller.dart';
...
class DriverTravelCalificationPage extends StatefulWidget {
  const DriverTravelCalificationPage({super.key});

  @override
  State<DriverTravelCalificationPage> createState() => _DriverTravelCalificationPageState();
}

class _DriverTravelCalificationPageState extends State<DriverTravelCalificationPage> {

  final _con = DriverTravelCalificationController();
