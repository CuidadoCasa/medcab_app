...
class CedulaProfesionalPage extends StatefulWidget {
  final String userId;
  
  const CedulaProfesionalPage({
    super.key,
    required this.userId
  });

  @override
  State<CedulaProfesionalPage> createState() => _CedulaProfesionalPageState();
}

class _CedulaProfesionalPageState extends State<CedulaProfesionalPage> {
  ...
  void _initData() async {
    ...
    if(datos.data() != null){
      ...
      urlFotoCedula = datosUser.containsKey('cedula') ? datosUser['cedula'] : '';
    }
      ...
      child: Column(
        children: [
          Align(
            ...
            child: _tituloSeccion('Imágen cédula', 17.5)
          ),
          _espacio(),
          _imageMarco(),
          _botonGuardar()
  ...
  void _crearRegistro() async {
    ...
    MisAvisos().ventanaTrabajando(context, 'Actualizando cédula...');
    ...
    try {
      ...
      if(mounted) Navigator.pop(context, {'newCedula': 1});
